...
import { Message, SlashCommandBuilder, ChatInputCommandInteraction, InteractionContextType, ContextMenuCommandBuilder, ApplicationCommandType, MessageContextMenuCommandInteraction } from 'npm:discord.js';
