import { Message, ChatInputCommandInteraction, SlashCommandBuilder, InteractionContextType, MessageFlags, ChannelType } from 'discord.js';
import xkcd from "../xkcd.ts";
import xkcd_subscribe from "./xkcd_subscribe.ts";
...
export default {
    ...
    interactionHandler(interaction: ChatInputCommandInteraction) {
        ...
        if (subcommand == "subscribe" || subcommand == "unsubscribe") xkcd_subscribe.handler(interaction, undefined, subcommand == "unsubscribe");
        else this.handler(interaction);
    }
};